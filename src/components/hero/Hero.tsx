    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-1 grid-rows-[minmax(0,36%)_minmax(0,64%)] lg:grid-rows-none lg:grid-cols-2 h-full w-full">
        ...
        >
          ...
          <div className="relative z-[1] max-w-2xl w-full space-y-7 sm:space-y-8" style={{ perspective: 900 }}>
            <motion.h1
            ...
            >
              <motion.span
                custom={0}
                variants={titleLine}
                className="block text-3xl sm:text-4xl lg:text-5xl font-normal tracking-tight mb-2 origin-left"
              >
                AI Learning
              </motion.span>
              <motion.span
                custom={1}
                variants={titleLine}
                className="block text-5xl sm:text-6xl lg:text-7xl xl:text-[4.75rem] font-black tracking-tight origin-left"
              >
                Build Your Future
              </motion.span>
            </motion.h1>
        ...
        <motion.div
          className="relative order-1 lg:order-2 flex items-end justify-center bg-transparent h-full min-h-0 overflow-hidden pt-12 lg:pt-0"
        >
          <motion.div
